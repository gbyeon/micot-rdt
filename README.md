...
3. Install the following packages from within Julia
	...
	L. Pkg.add("ArgParse")
	M. Optionally install the bridges to the commerical packages if you have them (CPLEX, Gurobi, etc.--see http://jump.readthedocs.io/en/latest/installation.html)
