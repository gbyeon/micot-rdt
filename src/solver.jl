...
export build_solver, build_solver_file
export IPOPT_SOLVER, CPLEX_SOLVER, MOSEK_SOLVER, BONMIN_SOLVER, SCS_SOLVER, GUROBI_SOLVER, CBC_SOLVER
...
# Create some solver related imports if packages are installed
...
#Builds the solver from a json string
